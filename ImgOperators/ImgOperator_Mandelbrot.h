#ifndef _H_LGP_OPERATOR_MANDELBROT_H
#define _H_LGP_OPERATOR_MANDELBROT_H

#include "../LGPComp/LGPOperator.h"

class ImgOperator_Mandelbrot : public LGPOperator
{
public:
	ImgOperator_Mandelbrot(unsigned int degree=2);
	virtual ~ImgOperator_Mandelbrot();
